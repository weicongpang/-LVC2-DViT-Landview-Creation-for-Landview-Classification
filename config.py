...
# Pin CPU memory in DataLoader for more efficient (sometimes) trans fer to GPU.
...
_C.MODEL.FLASH_INTERN_IMAGE.OFFSET_SCALE = 0.5
...
# Create a global config instance for direct import
config = _C.clone()